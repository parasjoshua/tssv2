...
/* @var $searchModel app\models\InventoryPrinterSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Inventory Printers';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="inventory-printer-index">
    ...
    <p>
        <?= Html::a('Create Inventory Printer', ['create'], ['class' => 'btn btn-success']) ?>
    </p>
    ...
    <?= GridView::widget([
        ...
        'panel'=>[
            'type'=>'info',
            'heading' => '<h3 class="panel-title"><i class="glyphicon glyphicon-print"></i> Printers</h3>',
        ],
        'export'=>[
            'fontAwesome'=>true,
