...
<div class="inventory-printer-form">
    ...
    <?= $form->field($model, 'type')->dropDownList([ 'Ribbon' => 'Ribbon', 'Ink' => 'Ink', 'Toner' => 'Toner', ], ['prompt' => 'Select']) ?>

    <?= $form->field($model, 'loan')->dropDownList([ 'Yes' => 'Yes', 'No' => 'No', ], ['prompt' => 'Select']) ?>
