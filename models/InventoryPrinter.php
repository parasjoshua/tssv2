...
/**
 * This is the model class for table "inventory_printer".
 *
 * @property int $id
 ...
 */
class InventoryPrinter extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['brand', 'model', 'serial_number', 'type', 'loan', 'inventory_number', 'date_of_purchased'], 'required'],
            [['type', 'loan'], 'string'],
